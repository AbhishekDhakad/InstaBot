...
reg1=Label(screen1,image=reg).place(relwidth=1,relheight=1)
...
btn_register=Button(frame1,bd=0,cursor="hand2",text="REGISTER",border=0,command=register, font=("times new roman",22),bg="green4", fg="black", width=16).place(x=260,y=480)
